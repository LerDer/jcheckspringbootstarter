...
import com.ler.jcheckspringbootstarter.annation.CheckContainer;
...
public class AopConfig {
	 ...
	 */
	@Pointcut("@annotation(com.ler.jcheckspringbootstarter.annation.CheckContainer) || @annotation(com.ler.jcheckspringbootstarter.annation.Check)")
